public class test {
       ...
       public static void testPatientList(PatientList list, String[] names,

                    int[] severities, int pos) {
...
class Patient {
       ...
       public boolean isAdmittedBefore(Patient other, int lastArrival) {
             ...
             if (severity == 3) {
                    ...
                    // admitted before, unless the other's severity is 3 and arrived
       ...
       public int checkSeverity(Patient other) {
             ...
             if (other.severity == severity)
                    ...
                    return (other.severity - severity);//if value returned > 0, other is admitted firstly
       ...
       public void add(String name, int severity) {
...

             {
               ...
               size++;// count the size of nodes
                    ...
                    int priority = head.data.checkSeverity(patient);
                    ...
                    if (priority > 0) {
                           ...
                           while(!checkFirst && (node.next != null)) {
                                 ...
                                 priority = node.next.data.checkSeverity(patient);
